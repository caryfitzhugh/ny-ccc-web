            ...
            subsections: [
              ...
              { name: "Extreme Weather",
                ...
                content: <ul>
                  ...
                  <SearchLink params={{facets: {sector: ["ny::telecommunications"]}, query: "telecommunications"}}>> Find more information</SearchLink>
                </ul>
              }
            ]},
          {title: "Actions",
            ...
            subsections: [
              { name:"Planning",
                ...
                content: <ul>
                  ...
                  <SearchLink params={{query: "telecommunications planning"}}>> Find more information</SearchLink>
                </ul>
              },
              { name: "Management Practices",
                ...
                content: <ul>
                  ...
                  <SearchLink params={{query: 'telecommunications management'}}>> Find more information</SearchLink>
                </ul>
              },
              { name: "Technology",
                id: "actions_outreach",
                content: <ul>
                  ...
                  <SearchLink params={{query: 'telecommunications technology'}}>> Find more information</SearchLink>
                </ul>
              },
              { name: "Policies / Laws",
                ...
                content: <ul>
                  ...
                  <SearchLink params={{query: 'telecommunications policy law'}}>> Find more information</SearchLink>
                </ul>
              },
