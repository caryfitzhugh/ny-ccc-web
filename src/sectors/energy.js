    ...
    return (
      <SectorDetailLayout
        ...
        sections={ [
          {title: "Energy",
            id: 'energy',
            content: <p>The Energy sector encompasses energy supply, demand, transmission, distribution, fuel sources, and technologies (transport-related energy considerations are in the Transportation sector).
